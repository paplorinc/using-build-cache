...
Before https://issuetracker.google.com/issues/115873047#comment24[AGP 3.6.0-alpha02] the test task in an Android project (`AndroidUnitTest`) was not cacheable.
